...
| Name | Type |
|------|------|
| [azurerm_role_assignment.st_contributors](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/role_assignment) | resource |
| [azurerm_role_assignment.st_readers](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/role_assignment) | resource |
| [azurerm_storage_account.this](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/storage_account) | resource |
| [azurerm_storage_container.this](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/storage_container) | resource |
| [azuread_groups.ad_group_ids](https://registry.terraform.io/providers/hashicorp/azuread/latest/docs/data-sources/groups) | data source |
...
| <a name="input_contributors"></a> [contributors](#input\_contributors) | List of AD Group display names to assign as Contributor to the storage account. | `list(string)` | `[]` | no |
...
| <a name="input_readers"></a> [readers](#input\_readers) | List of AD Group display names to assign as Reader to the storage account. | `list(string)` | `[]` | no |
